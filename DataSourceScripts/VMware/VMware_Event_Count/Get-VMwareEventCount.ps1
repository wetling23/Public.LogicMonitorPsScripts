<#
    ...
    .NOTES
        ...
        custom.vmwareevent.eventlist is a comma-separated list of event type IDs, for which to search.
    .LINK
...
Try {
    ...
    $logFile = "$logDirPath\datasource-VMware_Event_Count-collection-$computerName.log"
...
'@
    ...
    $EventFilter.EventTypeID = $eventArray
